    ...
    return (
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm hover:shadow-md transition-all duration-200 p-6 space-y-5">
            ...
            <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-indigo-600 to-purple-600 flex items-center justify-center shadow-md shadow-indigo-200">
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    {(status === "done" || status === "active") && (
                                        <p
                                            className={`text-[11px] font-medium mt-0.5 ${status === "done" ? "text-slate-400" : "text-indigo-400"
                                                }`}
                                        >
                                            {step.desc}
                                        </p>
