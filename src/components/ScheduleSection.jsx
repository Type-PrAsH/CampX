...
import { Calendar, Sparkles, Edit2, ChevronUp } from "lucide-react";
...
export default function ScheduleSection({ settings, onChange }) {
  ...
  const aiRecommendation = {
    ...
    explanation:
      "Based on historical engagement patterns of similar campaigns.",
  };
            ...
            <div className="space-y-1">
              ...
              <div className="flex flex-col gap-1">
                <p className="text-lg font-bold text-slate-900">
                  {aiRecommendation.day} {aiRecommendation.time}
                </p>
